...
class RegionServerMainStatusPayloadTest {
    ...
    void statusPayloadShouldContainCoreRuntimeFields() throws Exception {
        ...
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("decisionTerminalCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("decisionTerminalDroppedCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("terminalQueueCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("lastDecisionTerminalAtMs")).longValue());
        ...
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("decisionTerminalAgeMs")).longValue());
        ...
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaMarkCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaSyncFailureMarkCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaCommitTransportMarkCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaRecoveredCount")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaLastMarkedAtMs")).longValue());
        Assertions.assertEquals(0L, ((Number) replicaCommitRetry.get("suspectedReplicaLastRecoveredAtMs")).longValue());
        ...
        Assertions.assertTrue(((java.util.List<?>) replicaCommitRetry.get("suspectedReplicaPreview")).isEmpty());
        Assertions.assertTrue(((java.util.List<?>) replicaCommitRetry.get("decisionCandidatesPreview")).isEmpty());
        Assertions.assertTrue(((java.util.List<?>) replicaCommitRetry.get("decisionTerminalPreview")).isEmpty());
    ...
    void statusPayloadShouldIncludeProvidedTransferStats() throws Exception {
        ...
        replicaCommitRetry.put("decisionTerminalCount", 2L);
        replicaCommitRetry.put("decisionTerminalDroppedCount", 1L);
        replicaCommitRetry.put("terminalQueueCount", 2L);
        replicaCommitRetry.put("lastDecisionTerminalAtMs", 780L);
        replicaCommitRetry.put("decisionReadyAttemptsThreshold", 24L);
        replicaCommitRetry.put("maxAgeMs", 1800000L);
        replicaCommitRetry.put("decisionTerminalAgeMs", 3600000L);
        ...
        replicaCommitRetry.put("suspectedReplicaCount", 2L);
        replicaCommitRetry.put("suspectedReplicaMarkCount", 5L);
        replicaCommitRetry.put("suspectedReplicaSyncFailureMarkCount", 2L);
        replicaCommitRetry.put("suspectedReplicaCommitTransportMarkCount", 3L);
        replicaCommitRetry.put("suspectedReplicaRecoveredCount", 1L);
        replicaCommitRetry.put("suspectedReplicaLastMarkedAtMs", 700L);
        replicaCommitRetry.put("suspectedReplicaLastRecoveredAtMs", 701L);
        ...
        java.util.List<Map<String, Object>> suspectedReplicaPreview = new java.util.ArrayList<>();
        Map<String, Object> suspected = new LinkedHashMap<>();
        suspected.put("address", "127.0.0.1:3");
        suspected.put("reason", "commit_transport_error");
        suspected.put("lastTable", "orders");
        suspected.put("lastLsn", 9292L);
        suspected.put("syncFailureCount", 1L);
        suspected.put("commitTransportFailureCount", 3L);
        suspected.put("maxConsecutiveTransportFailures", 12L);
        suspected.put("firstSuspectedAtMs", 640L);
        suspected.put("lastSuspectedAtMs", 700L);
        suspectedReplicaPreview.add(suspected);
        replicaCommitRetry.put("suspectedReplicaPreview", suspectedReplicaPreview);
        ...
        java.util.List<Map<String, Object>> decisionTerminalPreview = new java.util.ArrayList<>();
        Map<String, Object> terminal = new LinkedHashMap<>();
        terminal.put("table", "orders");
        terminal.put("lsn", 9001L);
        terminal.put("address", "127.0.0.1:2");
        terminal.put("attempts", 33L);
        terminal.put("ageMs", 3700000L);
        terminal.put("queuedAtMs", 780L);
        terminal.put("lastError", "transport_error: timeout");
        decisionTerminalPreview.add(terminal);
        replicaCommitRetry.put("decisionTerminalPreview", decisionTerminalPreview);
        ...
        Assertions.assertEquals(2L, ((Number) commitRetryStats.get("decisionTerminalCount")).longValue());
        Assertions.assertEquals(1L, ((Number) commitRetryStats.get("decisionTerminalDroppedCount")).longValue());
        Assertions.assertEquals(2L, ((Number) commitRetryStats.get("terminalQueueCount")).longValue());
        Assertions.assertEquals(780L, ((Number) commitRetryStats.get("lastDecisionTerminalAtMs")).longValue());
        ...
        Assertions.assertEquals(3600000L, ((Number) commitRetryStats.get("decisionTerminalAgeMs")).longValue());
        ...
        Assertions.assertEquals(2L, ((Number) commitRetryStats.get("suspectedReplicaCount")).longValue());
        Assertions.assertEquals(5L, ((Number) commitRetryStats.get("suspectedReplicaMarkCount")).longValue());
        Assertions.assertEquals(2L, ((Number) commitRetryStats.get("suspectedReplicaSyncFailureMarkCount")).longValue());
        Assertions.assertEquals(3L, ((Number) commitRetryStats.get("suspectedReplicaCommitTransportMarkCount")).longValue());
        Assertions.assertEquals(1L, ((Number) commitRetryStats.get("suspectedReplicaRecoveredCount")).longValue());
        Assertions.assertEquals(700L, ((Number) commitRetryStats.get("suspectedReplicaLastMarkedAtMs")).longValue());
        Assertions.assertEquals(701L, ((Number) commitRetryStats.get("suspectedReplicaLastRecoveredAtMs")).longValue());
        ...
        java.util.List<?> suspectedPreviewRead = (java.util.List<?>) commitRetryStats.get("suspectedReplicaPreview");
        Assertions.assertEquals(1, suspectedPreviewRead.size());
        Map<?, ?> firstSuspected = (Map<?, ?>) suspectedPreviewRead.get(0);
        Assertions.assertEquals("127.0.0.1:3", firstSuspected.get("address"));
        Assertions.assertEquals("commit_transport_error", firstSuspected.get("reason"));
        Assertions.assertEquals(9292L, ((Number) firstSuspected.get("lastLsn")).longValue());
        ...
        java.util.List<?> terminalPreviewRead = (java.util.List<?>) commitRetryStats.get("decisionTerminalPreview");
        Assertions.assertEquals(1, terminalPreviewRead.size());
        Map<?, ?> firstTerminal = (Map<?, ?>) terminalPreviewRead.get(0);
        Assertions.assertEquals("orders", firstTerminal.get("table"));
        Assertions.assertEquals(9001L, ((Number) firstTerminal.get("lsn")).longValue());
